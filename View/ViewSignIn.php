...
<html>
        ...
        && empty($_GET['Request']))
    {
        ...
        <input type='text' class='text_1'name='User'/>
        <p><input type='password' class='text_1'name='Pwd'/></p>
        <p><input type='hidden' name='page' value='Connexion'></p>
        <input type='submit' class='bouton_1' name='Request' value='Se Connecter'></form></div>");
    }
    else
    {   
        if(empty($Query) 
            && empty($Check))
        {
            ...
            echo("<div><form action='Index.php' method='get'> 
            <input type='text' class='text_1'name='User'value='".htmlspecialchars($_GET['User'], ENT_QUOTES)."'/></p>
            <p> <input type='password' class='text_1'name='Pwd' value='".htmlspecialchars($_GET['Pwd'], ENT_QUOTES)."'/></p>
